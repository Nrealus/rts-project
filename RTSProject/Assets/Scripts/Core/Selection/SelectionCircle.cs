...
namespace Core.Selects
{
    public class SelectionCircle : MonoBehaviour
    {
        ...
        internal void MaterialsAndColorUpdate(Color colorToUse)
        {
            MeshRenderer selectionmr = GetComponentInChildren<MeshRenderer>();
            Material selectionmr_m = selectionmr.material;
            selectionmr_m.SetColor("_Color", colorToUse);
            selectionmr.material = selectionmr_m;

            LineRenderer selectionlr = GetComponentInChildren<LineRenderer>();
