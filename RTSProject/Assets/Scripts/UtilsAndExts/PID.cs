...
namespace UtilsAndExts
{
    ...
    public class PID : MonoBehaviour
    {
        ...
        public float GetOutput(float currentError, float deltaTime, float KpMultiplier, float KiMultiplier, float KdMultiplier)
        {
            P = currentError;
            I += P * deltaTime;
            D = (P - prevError) / deltaTime;
            ...
            return P * Kp * KpMultiplier + I * Ki * KiMultiplier + D * Kd * KdMultiplier;
        }
    }
